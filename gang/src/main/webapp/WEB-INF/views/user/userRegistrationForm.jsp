...
<div class="page-header">
	...
	<c:if test="${param.status ne null}">
		<p class="bg-success">${param.status}: Registration Successful!!</p>
	</c:if>
	...
	<form:form method="POST" commandName="user" cssClass="form-horizontal">
		...
		<div class="form-group">
			...
			<form:input path="mobileNumber"
						value="${mobileNumber}" cssClass="form-control" placeholder="10 Digit Mobile Number" maxlength="10"/>
			</div>
			<div class="col-sm-4">
		...
		<div class="form-group">
			<form:label path="address.locality" cssClass="col-sm-2 control-label">Locality</form:label>
			<div class="col-sm-6">
			<form:input path="address.locality"
						value="${address.locality}" cssClass="form-control" placeholder="Locality" />
			</div>
			<div class="col-sm-4"></div>			
		</div>
		<div class="form-group">
			...
			<form:input path="address.state"
						value="${address.state}" cssClass="form-control" placeholder="State" />
			</div>
			<div class="col-sm-4"></div>
		</div>
		<div class="row">
