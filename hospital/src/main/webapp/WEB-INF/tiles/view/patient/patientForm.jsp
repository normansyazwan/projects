...
<c:if test="${param.status ne null}">
	<p class="bg-success">${param.status}:Recordsaved successfully.
...
<form:form method="POST" commandName="patient"
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			<form:input path="bloodGroup" value="${bloodGroup}"
				cssClass="form-control" placeholder="Blood Group" />
		</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			<form:input path="existingAilments" value="${existingAilments}"
				cssClass="form-control" placeholder="Diabities, High BP" />
		</div>
		<div class="col-sm-4"></div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-6">
			<form:input path="allergies" value="${allergies}"
				cssClass="form-control" placeholder="Drug Allergies" />
		</div>
		<div class="col-sm-4"></div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			<form:input path="mobile" value="${mobile}" cssClass="form-control"
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			<form:input path="phone" value="${phone}" cssClass="form-control"
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			<form:input path="address.area" value="${address.area}"
				cssClass="form-control" placeholder="Area" />
		</div>
		<div class="col-sm-4"></div>
	</div>
	<div class="row">
