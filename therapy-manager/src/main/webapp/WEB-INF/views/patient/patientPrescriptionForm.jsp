...
<c:if test="${param.status ne null}">
	<p class="bg-success well well-sm">${param.status}: Record saved
...
<div class="row">
	...
	<div class="col-md-5">
		...
		<form:form class="form-horizontal" method="post"
			...
			<div class="form-group">
				...
				<form:textarea path="treatment" class="form-control" rows="3"
					cols="50"></form:textarea>
			</div>
			<div class="form-group">
	...
	<div class="col-md-6">
		...
		<div class="row">
			<div class="col-md-12">
				<a href='<c:url value="/patients/${patient.patientId}/profile" />'
